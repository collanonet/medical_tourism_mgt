...
import 'package:dio_cache_interceptor/dio_cache_interceptor.dart' as _i20;
import 'package:feature_agent/feature_agent.module.dart' as _i26;
import 'package:feature_auth/feature_auth.dart' as _i18;
...
import 'package:feature_process_chart/feature_process_chart.module.dart'
    as _i34;
import 'package:feature_quotation/feature_quotation.module.dart' as _i31;
import 'package:feature_report/feature_report.module.dart' as _i32;
import 'package:feature_sale/feature_sale.module.dart' as _i33;
import 'package:feature_web_appointment/feature_web_appointment.module.dart'
    as _i35;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;

import '../app/app_model.dart' as _i17;
import 'modules/rest_module.dart' as _i36;
import 'modules/storage_module.dart' as _i37;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i17.AppModel>(() => _i17.AppModel(
          auth: gh<_i18.AuthModel>(),
          l10n: gh<_i19.L10nModel>(),
        ));
    gh.singleton<_i20.CacheOptions>(restModule.cacheOptions);
    gh.singleton<_i21.Storage>(
    ...
    await _i31.FeatureQuotationPackageModule().init(gh);
    await _i32.FeatureReportPackageModule().init(gh);
    await _i33.FeatureSalePackageModule().init(gh);
    await _i34.FeatureProcessChartPackageModule().init(gh);
    await _i35.FeatureWebAppointmentPackageModule().init(gh);
    return this;
  }
}
