...
import 'package:feature_chats/feature_chats.module.dart' as _i15;
...
import 'package:socket_chat/socket_chat.module.dart' as _i28;

import '../app/app_model.dart' as _i21;
import '../routes/app_router.dart' as _i24;
import '../routes/guards.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await _i15.FeatureChatsPackageModule().init(gh);
    final storageModule = _$StorageModule();
    final appModule = _$AppModule();
    final restModule = _$RestModule();
    gh.factory<String>(() => storageModule.storagePrefixKey);
    gh.singleton<_i16.RoleGuard>(() => appModule.roleGuard);
    ...
    gh.singleton<_i24.AppRouter>(
        () => appModule.appRouter(gh<_i16.RoleGuard>()));
    ...
    await _i28.SocketChatPackageModule().init(gh);
