...
import 'package:core_network/core_network.dart' as _i25;
import 'package:core_network/core_network.module.dart' as _i27;
import 'package:core_storage/core_storage.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i21.Locale>(
      () => appModule.defaultLocale,
      instanceName: 'defaultLocale',
    );
    gh.singleton<_i22.RoleGuard>(appModule.roleGuard);
    gh.singleton<_i23.Storage>(
    ...
    gh.singleton<_i24.AppRouter>(appModule.appRouter(gh<_i22.RoleGuard>()));
    gh.singleton<_i25.RestClient>(restModule.restClient(
