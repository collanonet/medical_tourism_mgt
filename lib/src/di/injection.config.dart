...
import 'package:core_l10n/core_l10n.module.dart' as _i27;
import 'package:core_l10n/l10n.dart' as _i23;
import 'package:core_network/core_network.dart' as _i24;
import 'package:core_network/core_network.module.dart' as _i28;
...
import 'package:data_chats/data_chats.module.dart' as _i14;
import 'package:data_hospital/data_hospital.module.dart' as _i8;
import 'package:data_invoice/data_invoice.module.dart' as _i16;
...
import 'package:data_quotation/data_quotation.module.dart' as _i13;
...
import 'package:feature_agent/feature_agent.module.dart' as _i30;
import 'package:feature_auth/feature_auth.dart' as _i22;
import 'package:feature_auth/feature_auth.module.dart' as _i29;
import 'package:feature_chats/feature_chats.module.dart' as _i12;
import 'package:feature_hospital/feature_hospital.module.dart' as _i31;
import 'package:feature_invoice/feature_invoice.module.dart' as _i32;
import 'package:feature_medical_visa/feature_medical_visa.module.dart' as _i33;
import 'package:feature_patient/feature_patient.module.dart' as _i34;
import 'package:feature_process_chart/feature_process_chart.module.dart'
    as _i38;
import 'package:feature_quotation/feature_quotation.module.dart' as _i35;
import 'package:feature_report/feature_report.module.dart' as _i36;
import 'package:feature_sale/feature_sale.module.dart' as _i37;
...
import '../routes/app_router.dart' as _i26;
import '../routes/guards.dart' as _i18;
import 'modules/app_module.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await _i13.DataQuotationPackageModule().init(gh);
    await _i14.DataChatsPackageModule().init(gh);
    await _i15.DataWebAppointmentPackageModule().init(gh);
    await _i16.DataInvoicePackageModule().init(gh);
    ...
    await _i30.FeatureAgentPackageModule().init(gh);
    await _i31.FeatureHospitalPackageModule().init(gh);
    await _i32.FeatureInvoicePackageModule().init(gh);
    await _i33.FeatureMedicalVisaPackageModule().init(gh);
    await _i34.FeaturePatientPackageModule().init(gh);
    await _i35.FeatureQuotationPackageModule().init(gh);
    await _i36.FeatureReportPackageModule().init(gh);
    await _i37.FeatureSalePackageModule().init(gh);
    await _i38.FeatureProcessChartPackageModule().init(gh);
    await _i39.FeatureWebAppointmentPackageModule().init(gh);
    return this;
  }
}

class _$StorageModule extends _i40.StorageModule {}
