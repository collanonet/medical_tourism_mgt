...
class _ApiService implements ApiService {
  ...
  Future<List<SearchQAResponse>> getSearchQA({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<SearchQAResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map(
            (dynamic i) => SearchQAResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }

  @override
  Future<SearchQAResponse> postSearchQA(SearchQARequest searchQARequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(searchQARequest.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SearchQAResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SearchQAResponse.fromJson(_result.data!);
    return value;
  }
