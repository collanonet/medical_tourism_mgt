...
part 'application_risk_test_request.g.dart';

@JsonSerializable()
class ApplicationRiskTestRequest {
  DateTime? date1;
  DateTime? date2;
  DateTime? date3;
  bool? noDate;
  ...
  factory ApplicationRiskTestRequest.fromJson(Map<String,dynamic> json){
    return _$ApplicationRiskTestRequestFromJson(json);
  }

  Map<String,dynamic> toJson(){
    return _$ApplicationRiskTestRequestToJson(this);
  }
}
