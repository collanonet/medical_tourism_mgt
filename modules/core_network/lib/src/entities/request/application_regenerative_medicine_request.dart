...
part 'application_regenerative_medicine_request.g.dart';

@JsonSerializable()
class ApplicationRegenerativeMedicalRequest {
  ...
  factory ApplicationRegenerativeMedicalRequest.fromJson(
    ...
    return _$ApplicationRegenerativeMedicalRequestFromJson(json);
  }

  Map<String, dynamic> toJson() {
    return _$ApplicationRegenerativeMedicalRequestToJson(this);
  }
}
