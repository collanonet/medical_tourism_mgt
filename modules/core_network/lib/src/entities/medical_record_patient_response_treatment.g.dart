...
part of 'medical_record_patient_response_treatment.dart';
...
MedicalRecordPatientResponseTreatment
    _$MedicalRecordPatientResponseTreatmentFromJson(
...
Map<String, dynamic> _$MedicalRecordPatientResponseTreatmentToJson(
        MedicalRecordPatientResponseTreatment instance) =>
    <String, dynamic>{
      '_id': instance.id,
