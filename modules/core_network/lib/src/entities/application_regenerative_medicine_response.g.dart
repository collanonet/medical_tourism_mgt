...
part of 'application_regenerative_medicine_response.dart';
...
ApplicationRegenerativeMedicalResponse
    _$ApplicationRegenerativeMedicalResponseFromJson(
...
Map<String, dynamic> _$ApplicationRegenerativeMedicalResponseToJson(
        ApplicationRegenerativeMedicalResponse instance) =>
    <String, dynamic>{
      '_id': instance.id,
