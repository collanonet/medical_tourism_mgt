...
part of 'reversal_transaction.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ReversalTransaction _$ReversalTransactionFromJson(Map<String, dynamic> json) =>
    ReversalTransaction(
...
Map<String, dynamic> _$ReversalTransactionToJson(
        ReversalTransaction instance) =>
    <String, dynamic>{
      'id': instance.id,
