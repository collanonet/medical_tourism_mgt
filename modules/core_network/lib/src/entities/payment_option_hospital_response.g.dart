...
part of 'payment_option_hospital_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PaymentOptionHospitalResponse _$PaymentOptionHospitalResponseFromJson(
...
Map<String, dynamic> _$PaymentOptionHospitalResponseToJson(
        PaymentOptionHospitalResponse instance) =>
    <String, dynamic>{
      '_id': instance.id,
