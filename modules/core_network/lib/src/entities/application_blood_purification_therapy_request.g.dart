...
part of 'application_blood_purification_therapy_request.dart';
...
ApplicationBloodPurificationTherapyRequest
    _$ApplicationBloodPurificationTherapyRequestFromJson(
...
Map<String, dynamic> _$ApplicationBloodPurificationTherapyRequestToJson(
        ApplicationBloodPurificationTherapyRequest instance) =>
    <String, dynamic>{
