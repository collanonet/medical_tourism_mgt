...
@JsonSerializable()
class ApplicationBloodPurificationTherapyResponse {
  @JsonKey(name: '_id')
  String id;
  ...
  factory ApplicationBloodPurificationTherapyResponse.fromJson(
      Map<String, dynamic> json) {
    return _$ApplicationBloodPurificationTherapyResponseFromJson(json);
  }

  Map<String, dynamic> toJson() {
    return _$ApplicationBloodPurificationTherapyResponseToJson(this);
  }
}
