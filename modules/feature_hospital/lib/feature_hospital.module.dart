...
import 'src/detail/tabs/web_reservation/web_reservation_model.dart' as _i13;
import 'src/hospital_model.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i12.TreatmentModle>(() =>
        _i12.TreatmentModle(hospitalRepository: gh<_i4.HospitalRepository>()));
    gh.factory<_i13.WebReservationModel>(() => _i13.WebReservationModel(
        hospitalRepository: gh<_i4.HospitalRepository>()));
    gh.factory<_i14.HospitalModel>(() =>
        _i14.HospitalModel(hospitalRepository: gh<_i4.HospitalRepository>()));
  }
}
