...
class _MedicalRecordPassportSectionState
  ...
  Widget build(BuildContext context) {
    ...
    return Skeletonizer(
      enabled: context.read<BasicInformationModel>().patientPassport.loading,
      child: ReactiveForm(
        formGroup: formGroup,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: <Widget>[
                          addRadioButton(0, 'medicalGuarantee', formGroup),
                    ...
                    onTap: () {
                      setState(() {
                        formGroup.control('underConfirmation').value =
                            !selectUnderConfirmation;
                        selectUnderConfirmation = !selectUnderConfirmation;
                      });
                    },
