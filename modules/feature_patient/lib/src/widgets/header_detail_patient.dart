                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                            '${value.data?.firstNameChineseOrVietnamese ?? '--'} ${value.data?.middleNameChineseOrVietnamese ?? '--'} ${value.data?.familyNameChineseOrVietnamese ?? '--'}'),
                        SizedBox(
                          width: context.appTheme.spacing.marginMedium,
                        ),
                        Text(
                            '${value.data?.firstNameJapaneseForChinese ?? '--'} ${value.data?.middleNameJapaneseForChinese ?? '--'} ${value.data?.familyNameJapaneseForChinese ?? '--'}'),
                        SizedBox(
                          width: context.appTheme.spacing.marginMedium,
                        ),
                        Text(
                            '${value.data?.firstNameJapaneseForNonChinese ?? '--'} ${value.data?.middleNameJapaneseForNonChinese ?? '--'} ${value.data?.familyNameJapaneseForNonChinese ?? '--'}'),
                      ],
                    ),
                  ],
                ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {},
                          child: Text(value.data!.type?.first ?? '--'),
                        ),
                        SizedBox(
                          width: context.appTheme.spacing.marginMedium,
                        ),
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {},
                          child: Text(value.data?.progress ?? '--'),
                        ),
                      ],
                    ),
                    SizedBox(
                    ...
                    Row(
                      children: [
                        ...
                        Text(value.data?.proposalNumber ?? '--'),
                        SizedBox(
