...
import 'src/detail_patient/billing/billing_model.dart' as _i29;
import 'src/detail_patient/detail_patient_model.dart' as _i24;
import 'src/detail_patient/domestic_medical_data/domestic_medical_data_model.dart'
    as _i11;
import 'src/detail_patient/estimate/estimate_model.dart' as _i25;
...
import 'src/detail_patient/medical_visa/medical_visa_model.dart' as _i26;
...
import 'src/detail_patient/patient_response_data/tab/patient_response_treatment_model.dart'
    as _i21;
import 'src/detail_patient/progress_list/progress_list_model.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i15.BasicInformationModel>(() => _i15.BasicInformationModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i16.ApplicationRiskTestModel>(() =>
        _i16.ApplicationRiskTestModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i17.ApplicationBeautyModel>(() => _i17.ApplicationBeautyModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i18.ApplicationBloodPurificationTherapyModel>(() =>
        _i18.ApplicationBloodPurificationTherapyModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i19.ApplicationRegenerativeMedicalModel>(() =>
        _i19.ApplicationRegenerativeMedicalModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i20.PatientResponseOtherModel>(() =>
        _i20.PatientResponseOtherModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i21.PatientResponseTreatmentModel>(() =>
        _i21.PatientResponseTreatmentModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i22.PatientResponseMedicalCheckupModel>(() =>
        _i22.PatientResponseMedicalCheckupModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i23.PatientResponseModel>(() => _i23.PatientResponseModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i24.DetailPatientModel>(() => _i24.DetailPatientModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i25.EstimateModel>(() =>
        _i25.EstimateModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i26.MedicalVisaModel>(() =>
        _i26.MedicalVisaModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i27.MedicalPaymentDetailModel>(() =>
        _i27.MedicalPaymentDetailModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i28.ProgressListModel>(() =>
        _i28.ProgressListModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i29.BillingModel>(() =>
        _i29.BillingModel(patientRepository: gh<_i4.PatientRepository>()));
