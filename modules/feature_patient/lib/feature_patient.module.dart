...
import 'src/detail_patient/proposal_estimate/proposal_estimate_model.dart'
    as _i27;
import 'src/detail_patient/statement/statement_model.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i27.ProposalEstimateModel>(() => _i27.ProposalEstimateModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i28.StatementModel>(() =>
        _i28.StatementModel(patientRepository: gh<_i4.PatientRepository>()));
    ...
    gh.factory<_i31.DetailPatientWebReservationModel>(() =>
        _i31.DetailPatientWebReservationModel(
