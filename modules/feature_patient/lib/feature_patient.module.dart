...
import 'package:data_hospital/data_hospital.dart' as _i31;
import 'package:data_patient/data_patient.dart' as _i4;
import 'package:injectable/injectable.dart' as _i1;

import 'src/detail_patient/basic_info/basic_info_model.dart' as _i30;
import 'src/detail_patient/billing/billing_model.dart' as _i27;
import 'src/detail_patient/detail_patient_model.dart' as _i22;
import 'src/detail_patient/domestic_medical_data/domestic_medical_data_model.dart'
    as _i10;
import 'src/detail_patient/estimate/estimate_model.dart' as _i23;
...
import 'src/detail_patient/medical_visa/medical_visa_model.dart' as _i24;
...
import 'src/detail_patient/patient_response_data/tab/patient_response_treatment_model.dart'
    as _i19;
import 'src/detail_patient/progress_list/progress_list_model.dart' as _i26;
...
import 'src/pre_patient/pre_patient_model.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i14.ApplicationRiskTestModel>(() =>
        _i14.ApplicationRiskTestModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i15.ApplicationBeautyModel>(() => _i15.ApplicationBeautyModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i16.ApplicationBloodPurificationTherapyModel>(() =>
        _i16.ApplicationBloodPurificationTherapyModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i17.ApplicationRegenerativeMedicalModel>(() =>
        _i17.ApplicationRegenerativeMedicalModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i18.PatientResponseOtherModel>(() =>
        _i18.PatientResponseOtherModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i19.PatientResponseTreatmentModel>(() =>
        _i19.PatientResponseTreatmentModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i20.PatientResponseMedicalCheckupModel>(() =>
        _i20.PatientResponseMedicalCheckupModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i21.PatientResponseModel>(() => _i21.PatientResponseModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i22.DetailPatientModel>(() => _i22.DetailPatientModel(
        patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i23.EstimateModel>(() =>
        _i23.EstimateModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i24.MedicalVisaModel>(() =>
        _i24.MedicalVisaModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i25.MedicalPaymentDetailModel>(() =>
        _i25.MedicalPaymentDetailModel(
            patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i26.ProgressListModel>(() =>
        _i26.ProgressListModel(patientRepository: gh<_i4.PatientRepository>()));
    gh.factory<_i27.BillingModel>(() =>
    ...
    gh.factory<_i29.DetailPatientWebReservationModel>(() =>
        _i29.DetailPatientWebReservationModel(
            repository: gh<_i4.PatientRepository>()));
    gh.factory<_i30.BasicInformationModel>(() => _i30.BasicInformationModel(
          patientRepository: gh<_i4.PatientRepository>(),
          hospitalRepository: gh<_i31.HospitalRepository>(),
        ));
  }
}
