...
class ProcessChartModel extends ChangeNotifier {
  ...
  Future<void> fetchItinerary({
    ...
    await processChartRepository.getPatientChart(
        tourName: form?.control('tourName').value == null ? null : form!.control('tourName').value,
        classification: form?.control('classification').value == null ? null : form!.control('classification').value,
        dateFrom: form?.control('dateFrom').value == null ? null : form!.control('dateFrom').value,
        dateTo: form?.control('dateTo').value == null ? null : form!.control('dateTo').value,
      ).then((value){
