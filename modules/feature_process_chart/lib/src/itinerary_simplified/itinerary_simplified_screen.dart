            ...
            child: SingleChildScrollView(
              child: ColumnSeparated(
                ...
                children: [
                  Container(
                    ...
                    child: ColumnSeparated(
                      ...
                      children: [
                        ...
                        ReactiveForm(
                          formGroup: formGroup.control('title') as FormGroup,
                          child: ColumnSeparated(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            separatorBuilder:
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: ReactiveTextField(
                                      formControlName: 'Ending_time_planned',
                                      decoration: InputDecoration(
                                        label: Text(
                                          '終了時間（予定）',
                                        ),
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: ReactiveTextField(
                                      formControlName: 'health_checkup_package',
                                      decoration: InputDecoration(
                                        label: Text(
                                          '健康診断パッケージ',
                                        ),
                  ...
                  ReactiveForm(
                    formGroup: formGroup.control('interpreter_or_guide_input')
                        as FormGroup,
                    child: ColumnSeparated(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      separatorBuilder: (BuildContext context, int index) {
                  ...
                  ReactiveForm(
                    formGroup: formGroup.control('Transfer_input') as FormGroup,
                    child: ColumnSeparated(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      separatorBuilder: (BuildContext context, int index) {
                        return SizedBox(
