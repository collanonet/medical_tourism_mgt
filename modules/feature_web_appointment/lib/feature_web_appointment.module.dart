...
// Project imports:
import 'src/detail/web_appointment_detail_model.dart' as _i5;
import 'src/web_appointment_model.dart' as _i3;

class FeatureWebAppointmentPackageModule extends _i1.MicroPackageModule {
// initializes the registration of main-scope dependencies inside of GetIt
  @override
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    gh.factory<_i3.WebAppointmentModel>(() => _i3.WebAppointmentModel(
        repository: gh<_i4.WebAppointmentRepository>()));
    gh.factory<_i5.WebAppointmentDetailModel>(() =>
        _i5.WebAppointmentDetailModel(
            repository: gh<_i4.WebAppointmentRepository>()));
  }
}
